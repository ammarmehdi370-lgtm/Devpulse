    ...
    <div className="p-6 sm:p-8 max-w-[1240px] mx-auto space-y-6">
        ...
        actions={
          <>
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-[#141420] hover:bg-[#1b1b2a] border border-[#272738] text-xs font-mono text-[#d0d0e2] flex items-center gap-2 transition-all disabled:opacity-60"
            >
              {isRerunning ? (
                <Loader2 className="w-3.5 h-3.5 animate-spin text-[#0DF5C4]" />
              ) : (
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl text-xs font-semibold text-[#09090e] flex items-center gap-2 shadow-lg transition-transform hover:scale-[1.02] active:scale-98 disabled:opacity-60"
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-[#12121b] border border-[#20202e] rounded-2xl p-4 space-y-1 shadow-md">
          <div className="text-[10px] font-mono uppercase tracking-wider text-[#6a6a84] flex items-center gap-1">
            GLOBAL P99 LATENCY
            <HelpfulInfo
        ...
        <div className="lg:col-span-8 bg-[#101017] border border-[#20202e] rounded-2xl p-5 shadow-xl space-y-4">
          ...
          <div className="space-y-3 overflow-x-auto">
            {isDataLoading ? (
              ...
              <div className="rounded-xl border border-dashed border-[#2b2b40] p-8 text-center text-xs text-[#8b8ba8]">
                ...
                >
                  <div className="space-y-1">
                    ...
                    <div className="text-[11px] text-[#7a7a98] font-mono">
                      Target:{" "}
                      <span className="text-[#a4a4c4]">{dep.domain}</span>
                    </div>
              ...
              >
                <div className="space-y-0.5">
                  <div className="font-bold text-white tracking-wide">
                    ...
                    {item.key === "VECTOR_EMBEDDING_MODEL" && (
                      <span className="ml-2 text-[10px] font-normal text-[#8b8ba8]">
                        non-secret
                      </span>
                    )}
                  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="text-[#7e7e9a] hover:text-[#f87171] p-1 disabled:opacity-50"
