...
export const PricingPage: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Never. Across all plans, including Free and Pro, Codeplane maintains strict zero-data agreements with AI model providers. Your codebase is never ingested for model fine-tuning.'
    },
    {
        ...
        <div className="bg-[#111119] border border-[#20202e] rounded-3xl p-7 flex flex-col justify-between shadow-xl space-y-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#7e7e98] mt-0.5">Perfect for side projects</p>
            </div>

            <div className="pt-2">
              <span className="text-4xl font-extrabold text-white font-mono">$0</span>
              <span className="text-xs text-[#7e7e98] font-mono ml-2">/ month</span>
              <div className="text-[11px] text-[#0DF5C4] font-mono mt-1">Free forever · No card required</div>
            </div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#8e8ea6] mt-0.5">For active developers & fast moving small teams scaling micro-services.</p>
            </div>

            <div className="pt-2">
              <span className="text-4xl font-extrabold text-white font-mono">${proPrice}</span>
              <span className="text-xs text-[#8e8ea6] font-mono ml-2">/ month</span>
              <div className="text-[11px] text-[#0DF5C4] font-mono mt-1">
                {billingCycle === 'annual' ? 'Billed annually ($180/yr)' : 'Billed monthly · Cancel anytime'}
              </div>
            </div>
        ...
        <div className="bg-[#111119] border border-[#20202e] rounded-3xl p-7 flex flex-col justify-between shadow-xl space-y-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#7e7e98] mt-0.5">For scaling engineering orgs needing custom isolation & strict compliance.</p>
            </div>

            <div className="pt-2">
              <span className="text-4xl font-extrabold text-white font-mono">${enterprisePrice}</span>
              <span className="text-xs text-[#7e7e98] font-mono ml-2">/ user / month</span>
              <div className="text-[11px] text-[#8e8ea6] font-mono mt-1">Annual contract · 10 user min</div>
            </div>
            ...
            <div className="space-y-3 pt-4 border-t border-[#1d1d2c] text-xs text-[#c4c4dc]">
              <div className="flex items-center gap-2.5">
                <Check className="w-4 h-4 text-[#0DF5C4]" />
                <strong className="font-semibold text-white">Everything in Pro</strong>
              </div>
              <div className="flex items-center gap-2.5">
                <Check className="w-4 h-4 text-[#0DF5C4]" />
          ...
          <button
            onClick={() => alert('Contacting Codeplane Enterprise engineering sales team.')}
            className="w-full py-3 px-4 rounded-xl bg-[#171724] hover:bg-[#202032] border border-[#2b2b40] text-white font-semibold text-xs transition-colors flex items-center justify-center gap-2"
          >
      ...
      <div className="bg-[#11111a] border border-[#20202e] rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
        <div className="max-w-2xl">
          ...
          <p className="text-xs text-[#8c8ca5] mt-1 leading-relaxed">
            Compile-time enforced multi-tenant memory fencing with hardware-level microVM isolation. Your code never leaves your safeguard-compliant boundaries.
          </p>
        </div>
        ...
        <div className="space-y-3">
          {faqs.map((faq, i) => (
            ...
            >
              ...
              >
                <span>{faq.q}</span>
                {expandedFaq === i ? <ChevronUp className="w-4 h-4 text-[#787896]" /> : <ChevronDown className="w-4 h-4 text-[#787896]" />}
              </button>
