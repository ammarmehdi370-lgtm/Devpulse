...
export const EditorWorkbench: React.FC = () => {
  ...
  useEffect(() => {
    const onKeyDown = (event: KeyboardEvent) => {
      if (event.altKey && event.key.toLowerCase() === "h" && activeFile?.origin === FileOrigin.API) { event.preventDefault(); setIsAiDrawerOpen(false); setIsRevisionPanelOpen((open) => !open); return; }
      ...
      else if (event.key.toLowerCase() === "i") { event.preventDefault(); setIsRevisionPanelOpen(false); setIsAiDrawerOpen((open) => !open); }
