  ...
  return (
    <div className="min-h-screen w-full bg-[#08080c] text-white p-4 sm:p-8 flex flex-col items-center justify-center relative font-sans">
      ...
      <div className="w-full max-w-[1240px] z-10 space-y-6">
        <FriendlyHint
          title="Theme choice"
          body="This screen changes the look of the app only. Your projects, workspaces, and settings stay the same while you pick a color style that feels easiest to read."
        />
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#7e7e98]">
                This changes how the app looks — you can change it anytime. Pick
                a style that feels comfortable to you.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
              ...
              >
                <div className="flex justify-between items-center text-xs font-medium text-white/90">
                  ...
                  <label className="bg-black/25 px-2 py-0.5 rounded backdrop-blur-sm flex items-center gap-1.5 cursor-pointer hover:bg-black/40">
                    ...
                    <HelpfulInfo
                      text="Primary color is the main accent that highlights buttons and important actions."
                      className="ml-1"
                    />
                  </label>
                </div>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="bg-[#12121a] border border-[#20202e] rounded-2xl p-6 h-[178px] flex flex-col justify-between shadow-lg relative overflow-hidden group">
              ...
              <div className="text-[11px] text-[#6b6b85] font-mono text-center">
                SemiBold · 28px - 48px
              </div>
            </div>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="bg-[#12121a] border border-[#20202e] rounded-2xl p-5 shadow-lg space-y-4">
              <div className="grid grid-cols-2 gap-2.5">
                ...
                {/* Secondary Button */}
                <button className="py-2.5 px-3 rounded-lg text-xs font-semibold bg-[#1a1a26] hover:bg-[#222234] border border-[#2e2e42] text-[#d5d5e8] transition-colors">
                  Secondary
                </button>
                {/* Inverted Button */}
                <button className="py-2.5 px-3 rounded-lg text-xs font-semibold bg-white text-black hover:bg-white/90 transition-colors">
                  Inverted
                </button>
                {/* Outlined Button */}
                <button className="py-2.5 px-3 rounded-lg text-xs font-medium border border-[#3e3e56] text-[#b8b8d0] hover:border-white/40 transition-colors">
                  Outlined
                </button>
              </div>
            ...
            <div className="bg-[#12121a] border border-[#20202e] rounded-2xl p-5 shadow-lg flex items-center justify-between gap-3">
              ...
              <div
                ...
                style={{
                  ...
                  color: customPrimary,
                  border: `1px solid ${customPrimary}50`,
                }}
              >
